...
#### 2. Abstract Factory Pattern [SOLD]:
...
#### 7. Chain of Responsibility Pattern [SLI]:
...
#### 9. Dependency Injection (DI) / Inversion of Control (IoC) Container [D]:
...
#### 10. Command Query Responsibility Segregation (CQRS) [SOI]:
...
#### 13. Template Method Pattern [OLD]:
